...
export var _scrollEffects = {};
export var _scrollTimer = null;
export var scrollTimingFunction = function easeOutQuad(t, b, c, d) {
  t /= d;
  return -c * t * (t - 2) + b;
};
/**
...
export var registerEffect = function registerEffect(effectName, effectDef) {
...
export var queryAllRoot = function queryAllRoot(selector, root) {
  var queue = [root];
  var matches = [];
...
export var scroll = function scroll(options) {
  options = options || {};
