...
switch(page){case"app-home":new Promise((res,rej)=>_require.default(["./app-home.js"],res,rej)).then(bundle=>bundle&&bundle.$appHome||{});break;case"app-credits":new Promise((res,rej)=>_require.default(["./app-credits.js"],res,rej)).then(bundle=>bundle&&bundle.$appCredits||{});break;case"app-404":new Promise((res,rej)=>_require.default(["./app-404.js"],res,rej)).then(bundle=>bundle&&bundle.$app$404||{});break;}}}window.customElements.define("my-app",MyApp);const $_documentContainer$5=document.createElement("template");$_documentContainer$5.innerHTML=`<dom-module id="shared-styles">
	<template>
		<style>
			.main {
                padding: 1rem 2rem;
