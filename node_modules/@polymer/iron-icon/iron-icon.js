define(["../polymer/polymer-legacy.js", "../iron-meta/iron-meta.js", "../iron-flex-layout/iron-flex-layout.js", "../polymer/lib/legacy/polymer-fn.js", "../polymer/lib/utils/html-tag.js", "../polymer/lib/legacy/polymer.dom.js"], function (_polymerLegacy, _ironMeta, _ironFlexLayout, _polymerFn, _htmlTag, _polymerDom) {
  ...
  var _templateObject_6359d170026311eaac49df79b6a433b4 = /*#__PURE__*/ babelHelpers.taggedTemplateLiteral(["\n    <style>\n      :host {\n        @apply --layout-inline;\n        @apply --layout-center-center;\n        position: relative;\n\n        vertical-align: middle;\n\n        fill: var(--iron-icon-fill-color, currentcolor);\n        stroke: var(--iron-icon-stroke-color, none);\n\n        width: var(--iron-icon-width, 24px);\n        height: var(--iron-icon-height, 24px);\n        @apply --iron-icon;\n      }\n\n      :host([hidden]) {\n        display: none;\n      }\n    </style>\n"]);

  (0, _polymerFn.Polymer)({
    _template: (0, _htmlTag.html)(_templateObject_6359d170026311eaac49df79b6a433b4),
    is: 'iron-icon',
    properties: {
      /**
