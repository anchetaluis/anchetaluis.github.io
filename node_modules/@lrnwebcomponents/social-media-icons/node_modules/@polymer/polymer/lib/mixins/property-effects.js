define(["exports", "../utils/boot.js", "../utils/wrap.js", "../utils/mixin.js", "../utils/path.js", "../utils/case-map.js", "./property-accessors.js", "./template-stamp.js", "../utils/settings.js"], function (_exports, _boot, _wrap, _mixin, _path, _caseMap, _propertyAccessors, _templateStamp, _settings) {
  "use strict";
  ...
  function getArgValue(data, props, path) {
    var value = (0, _path.get)(data, path); // when data is not stored e.g. `splices`, get the value from changedProps
    ...
    function (_propertyEffectsBase) {
      ...
      babelHelpers.createClass(PropertyEffects, [{
        ...
        value: function _setPendingProperty(property, value, shouldNotify) {
          var propIsPath = this.__dataHasPaths && (0, _path.isPath)(property);
        ...
        value: function _marshalArgs(args, path, props) {
          ...
          for (var i = 0, l = args.length; i < l; i++) {
            ...
            if (!literal) {
              if (wildcard) {
                var matches = (0, _path.isDescendant)(name, path);
