define(["exports", "./boot.js", "../mixins/property-effects.js", "../mixins/mutable-data.js", "./settings.js", "./wrap.js"], function (_exports, _boot, _propertyEffects, _mutableData, _settings, _wrap) {
  ...
  */
  ...
  var templateInstanceBase = (0, _propertyEffects.PropertyEffects)(
  /*#__PURE__*/
  ...
  var MutableTemplateInstanceBase = (0, _mutableData.MutableData)( // This cast shouldn't be necessary, but Closure doesn't seem to understand
  // this constructor.
