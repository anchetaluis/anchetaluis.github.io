define(["exports", "../../polymer-element.js", "../utils/templatize.js", "../utils/debounce.js", "../utils/flush.js", "../utils/async.js", "../utils/path.js", "../utils/wrap.js", "../utils/hide-template-controls.js"], function (_exports, _polymerElement, _templatize, _debounce, _flush, _async, _path, _wrap, _hideTemplateControls) {
  "use strict";
  ...
  function (_PolymerElement) {
    ...
    babelHelpers.createClass(DomIf, [{
      ...
      value: function __ensureInstance() {
        ...
        var parentNode = (0, _wrap.wrap)(this).parentNode; // Guard against element being detached while render was queued
