define(["exports", "./legacy-element-mixin.js", "../utils/settings.js"], function (_exports, _legacyElementMixin, _settings) {
  ...
  */
    ...
    function (_Base) {
      ...
      babelHelpers.createClass(PolymerGenerated, [{
        ...
        value: function _registered() {
          ...
          */
          ...
          if (!generatedProto.hasOwnProperty('__hasRegisterFinished')) {
            ...
            babelHelpers.get(PolymerGenerated.prototype.__proto__ || Object.getPrototypeOf(PolymerGenerated.prototype), "_registered", this).call(this); // copy properties onto the generated class lazily if we're optimizing,
        ...
        value: function attributeChanged(name, old, value) {
          babelHelpers.get(PolymerGenerated.prototype.__proto__ || Object.getPrototypeOf(PolymerGenerated.prototype), "attributeChanged", this).call(this);
  ...
  var Class = function Class(info, mixin) {
    ...
    var klass = mixin ? mixin((0, _legacyElementMixin.LegacyElementMixin)(HTMLElement)) : (0, _legacyElementMixin.LegacyElementMixin)(HTMLElement);
