(function () {
  ...
  */
  ...
  function r(a) {
    p = a && a.shimcssproperties ? !1 : k || !(navigator.userAgent.match(/AppleWebKit\/601|Edge\/15/) || !window.CSS || !CSS.supports || !CSS.supports("box-shadow", "0 0 0 var(--foo)"));
  }
  ...
  function x(a, b) {
    ...
    a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1), c = da(c), c = c.replace(y, " "), c = c.substring(c.lastIndexOf(";") + 1), c = a.parsedSelector = a.selector = c.trim(), a.atRule = 0 === c.indexOf("@"), a.atRule ? 0 === c.indexOf("@media") ? a.type = z : c.match(ea) && (a.type = A, a.keyframesName = a.selector.split(y).pop()) : a.type = 0 === c.indexOf("--") ? B : C);
  ...
  function D(a, b, c) {
    ...
    if (a.cssText || a.rules) {
      ...
      } else b ? b = a.cssText : (b = a.cssText, b = b.replace(fa, "").replace(ha, ""), b = b.replace(ia, "").replace(ja, "")), (d = b.trim()) && (d = "  " + d + "\n");
    }
  ...
  function K(a) {
    !a.__cssRules && a.textContent && (a.__cssRules = w(a.textContent));
  ...
  function na(a, b, c) {
    b = b.replace(E, function (d, e, f, g) {
      return oa(a, d, e, f, g, c);
    });
    return S(a, b, c);
  }
  ...
  function pa(a, b) {
    ...
    var d = {},
        e = !1;
    L(c, function (f) {
      (e = e || f === b) || f.selector === b.selector && Object.assign(d, T(a, f.parsedCssText));
    });
    return d;
  }

  function S(a, b, c) {
    for (var d; d = H.exec(b);) {
      var e = d[0],
          f = d[1];
      d = d.index;
      var g = b.slice(0, d + e.indexOf("@apply"));
      b = b.slice(d + e.length);
      var h = c ? pa(a, c) : {};
      ...
      if (m) {
        ...
        for (e in q) {
          l = h && h[e], m = [e, ": var(", f, "_-_", e], l && m.push(",", l.replace(O, "")), m.push(")"), O.test(q[e]) && m.push(" !important"), n.push(m.join(""));
        }
      }

      e = n.join("; ");
      b = g + e + b;
      H.lastIndex = d + e.length;
    }
  ...
  function T(a, b, c) {
    ...
    for (var d, e, f = {}, g = 0, h; g < b.length; g++) {
      if (d = b[g]) if (h = d.split(":"), 1 < h.length) {
        d = h[0].trim();
        e = h.slice(1).join(":");
        ...
        if (c) {
          ...
          h = d;
          var n = ma.exec(e);
          n && (n[1] ? (l.b || (l.b = document.createElement("meta"), l.b.setAttribute("apply-shim-measure", ""), l.b.style.all = "initial", document.head.appendChild(l.b)), h = window.getComputedStyle(l.b).getPropertyValue(h)) : h = "apply-shim-inherit", e = h);
        }
  ...
  function X(a) {
    !a.a && window.ShadyCSS.CustomStyleInterface && (a.a = window.ShadyCSS.CustomStyleInterface, a.a.transformCallback = function (b) {
      V.f(b);
  ...
  W.prototype.styleElement = function (a) {
    ...
    if (!(b && "" !== N(b) || !b || ta(b))) {
      if (ta(b) || b._applyShimValidatingVersion !== b._applyShimNextVersion) this.prepareTemplate(b, c), ua(b);
      if (a = a.shadowRoot) if (a = a.querySelector("style")) a.__cssRules = b._styleAst, a.textContent = J(b._styleAst);
    }
  };
  ...
  if (!window.ShadyCSS || !window.ShadyCSS.ScopingShim) {
    ...
    window.ShadyCSS = {
      prepareTemplate: function prepareTemplate(a, b) {
        Y.flushCustomStyles();
      ...
      prepareTemplateDom: function prepareTemplateDom() {},
