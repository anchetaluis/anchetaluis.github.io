define(["exports", "./css-parse.js", "./style-settings.js", "./style-transformer.js", "./style-util.js", "./common-regex.js", "./style-info.js"], function (_exports, _cssParse, _styleSettings, _styleTransformer, StyleUtil, RX, _styleInfo) {
  /**
  @license
  ...
  */
  ...
  RX = babelHelpers.interopRequireWildcard(RX);
  _styleInfo = babelHelpers.interopRequireDefault(_styleInfo);
  ...
  function () {
    function StyleProperties() {
      babelHelpers.classCallCheck(this, StyleProperties);
    }

    babelHelpers.createClass(StyleProperties, [{
      key: "decorateStyles",
      ...
      value: function whenHostOrRootRule(scope, rule, cssBuild, callback) {
        ...
        var hostScope = is ? _styleTransformer.default._calcHostScope(is, typeExtension) : 'html';
        ...
        if (isHost) {
          ...
          if (!rule.transformedSelector) {
            ...
            rule.transformedSelector = _styleTransformer.default._transformRuleCss(rule, _styleTransformer.default._transformComplexSelector, _styleTransformer.default._calcElementScope(is), hostScope);
          }
      ...
      value: function transformStyles(element, properties, scopeSelector) {
        ...
        var hostSelector = _styleTransformer.default._calcHostScope(is, typeExtension);

        var rxHostSelector = element.extends ? '\\' + hostSelector.slice(0, -1) + '\\]' : hostSelector;
        var hostRx = new RegExp(RX.HOST_PREFIX + rxHostSelector + RX.HOST_SUFFIX);

        var _StyleInfo$get = _styleInfo.default.get(element),
        ...
        return _styleTransformer.default.elementStyles(element, rules, function (rule) {
      ...
      value: function applyElementStyle(element, properties, selector, style) {
        ...
        var styleInfo = _styleInfo.default.get(element);
      ...
      value: function applyCustomStyle(style, properties) {
        var rules = StyleUtil.rulesForStyle(
        ...
        rule) {
          ...
          if (rule.propertyInfo && rule.propertyInfo.cssText) {
            ...
            css = (0, _cssParse.removeCustomPropAssignment)(
            /** @type {string} */
  ...
  var _default = new StyleProperties();
