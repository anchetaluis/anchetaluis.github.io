define(["exports", "./css-parse.js", "./style-util.js", "./style-settings.js"], function (_exports, _cssParse, StyleUtil, _styleSettings) {
  /**
  @license
  ...
  */
  ...
  function () {
    function StyleTransformer() {
      babelHelpers.classCallCheck(this, StyleTransformer);
    }

    babelHelpers.createClass(StyleTransformer, [{
      key: "dom",
      ...
      value: function css(rules, scope, ext, callback) {
        ...
        var self = this;
        return StyleUtil.toCssText(rules, function (
        /** StyleNode */
        rule) {
          if (!rule.isScoped) {
      ...
      value: function _transformRuleCss(rule, transformer, scope, hostScope) {
        var p$ = StyleUtil.splitSelectorList(rule['selector']); // we want to skip transformation of rules that appear in keyframes,
  ...
  var _default = new StyleTransformer();
